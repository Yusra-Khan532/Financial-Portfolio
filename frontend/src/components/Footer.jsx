    ...
    <footer className="border-t border-[var(--border-subtle)] bg-[var(--footer-bg)] px-6 py-12 transition-colors duration-300 md:px-10 md:py-14">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-10 py-10 sm:grid-cols-2 lg:grid-cols-[1.35fr_.8fr_1fr] lg:gap-16">
          <div><img src={finlitLogo} alt="FinLit" className="h-20 w-auto object-contain" /><div className="mt-3 text-[10px] uppercase tracking-[0.29em] text-[#F5A623]">Investment Research</div><p className="mt-5 max-w-xs text-sm leading-relaxed text-[var(--text-muted)]">Research-led perspectives across Indian and global markets.</p></div>
