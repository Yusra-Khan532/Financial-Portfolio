...
export default function Performance() {
  ...
  return <section id="performance" className="relative px-6 py-20 md:px-10 md:py-24"><div className="mx-auto max-w-7xl">
    <Reveal><div className="mb-5 flex items-center gap-3"><span className="text-[11px] uppercase tracking-[.28em] text-[#F5A623]">Performance</span><span className="h-px w-8 bg-[#F5A623]/50" /><span className="text-[11px] uppercase tracking-[.22em] text-[#94A3B8]">{profile.reportPeriod}</span></div><div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between"><h2 className="max-w-2xl font-serif-display text-4xl leading-[1.05] tracking-tight text-white sm:text-5xl lg:text-6xl">Performance, measured with context.</h2><p className="max-w-sm text-base leading-relaxed text-[#94A3B8]">Report period {profile.reportPeriod} · Average deployed capital {profile.deployedCapital}.</p></div></Reveal>
